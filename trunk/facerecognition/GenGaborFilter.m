function [filters] = GenGaborFilter(filter_size, filter_direction)
%% GABORFILTER Perform the gabor filter on input face
%filters      ---generated gabor filters


%% ##################Generate 24 Gabor filter###################
filters = cell(filter_size, filter_direction);
