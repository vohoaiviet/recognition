function [accuracy] = test_stage_rfld(test_face_path, projected_face, pca_matrix, rfld_matrix, train_face_name)
...
for i = 1 : file_num
    if (~test_face_name(i).isdir)
        ...
        pca_rfld_projected = (test_face' * pca_matrix) * rfld_matrix;
...
fid = fopen('result_orl_fr_rfld.txt', 'wt');
